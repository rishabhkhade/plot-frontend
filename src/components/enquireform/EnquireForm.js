...
function EnquireForm() {
    ...
    const handleSubmit = async (e) => {
        e.preventdefault();
        try {
            const response = await axios.post(`${process.env.REACT_APP_API_URL}/customer/addEnquiry`,
                enquireForm
            );
                ...
                <div className="container enquire-form-cont">
                    <form class="add-project-form" onSubmit={handleSubmit}>
                        <input
                            ...
                            onChange={(e) => setEnquireForm({
                                ...enquireForm, name: e.target.value
                            })}
                        />
                        <input
                            type="number"
                            ...
                            onChange={(e) => setEnquireForm({
                                ...enquireForm, number: e.target.value
                            })}
                        ...
                        <input
                            ...
                            onChange={(e) => setEnquireForm({
                                ...enquireForm, enquiry: e.target.value
                            })}
                        />
                        <input
                            type="text"
                            ...
                            onChange={(e) => setEnquireForm({
                                ...enquireForm, feedback: e.target.value
                            })}
                        />
                        <div class="col-md-12">
                            <select
                                ...
                                onChange={(e) => setEnquireForm({
                                    ...enquireForm, status: e.target.value
                                })}
